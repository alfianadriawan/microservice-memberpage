  ...
  return (
    <div className="flex flex-col mb-4">
      ...
      <div className="relative" ref={selectWrapper} onClick={toggleSelect}>
        ...
        >
          <span className={value === "" ? "text-gray-500" : "text-green-800"}>
        ...
        >
          {items.map((item, index) => {
            return (
              <div
                key={index}
                className="cursor-pointer text-gray-800 px-4 py-1 bg-white hover:bg-gray-400 transition-all duration-200"
                onClick={() =>
